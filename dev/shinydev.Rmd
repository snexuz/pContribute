...
## ui.r input
inputPanel(
 selectInput('county', '請選擇縣市', choices = nms, selected = "新北市"),
 tags$head(tags$style(".selectize-control.single { width: 400px; z-index: 1; }
                       .shiny-input-panel{padding: 0px; margin-top: 10px;  margin-bottom: -40px;  background-color: rgba(0,0,0,0);  border: rgba(0,0,0,0);}"))
)
